var Flourish = function (t) {
    ...
    1 === (M = C).length && (E = M, M = function (e, t) {
        return C(E(e), t)
    });
    var E, M, A = "http://www.w3.org/1999/xhtml",
        D = {
    ...
    function z(e, t, n, r, i, a) {
        for (var o, c = 0, u = t.length, f = a.length; c < f; ++c)(o = t[c]) ? (o.__data__ = a[c], r[c] = o) : n[c] = new B(e, a[c]);
    ...
    function V(e, t, n, r, i, a, o) {
        var c, u, f, s = {},
            ...
            d = a.length,
            h = new Array(l);
        for (c = 0; c < l; ++c)(u = t[c]) && (h[c] = f = Y + o.call(u, u.__data__, c, t), f in s ? i[c] = u : s[f] = u);
        for (c = 0; c < d; ++c)(u = s[f = Y + o.call(e, a[c], c, a)]) ? ((r[c] = u).__data__ = a[c], s[f] = null) : n[c] = new B(e, a[c]);
    ...
    function je(e) {
        var t;
        return e = (e + "").trim().toLowerCase(), (t = Ce.exec(e)) ? new Ie((t = parseInt(t[1], 16)) >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | 240 & t, (15 & t) << 4 | 15 & t, 1) : (t = Ee.exec(e)) ? He(parseInt(t[1], 16)) : (t = Me.exec(e)) ? new Ie(t[1], t[2], t[3], 1) : (t = Ae.exec(e)) ? new Ie(255 * t[1] / 100, 255 * t[2] / 100, 255 * t[3] / 100, 1) : (t = De.exec(e)) ? Re(t[1], t[2], t[3], t[4]) : (t = Ue.exec(e)) ? Re(255 * t[1] / 100, 255 * t[2] / 100, 255 * t[3] / 100, t[4]) : (t = Ne.exec(e)) ? Be(t[1], t[2] / 100, t[3] / 100, 1) : (t = Oe.exec(e)) ? Be(t[1], t[2] / 100, t[3] / 100, t[4]) : Fe.hasOwnProperty(e) ? He(Fe[e]) : "transparent" === e ? new Ie(NaN, NaN, NaN, 0) : null
    }
    ...
    function Be(e, t, n, r) {
        return r <= 0 ? e = t = n = NaN : n <= 0 || 1 <= n ? e = t = NaN : t <= 0 && (e = NaN), new Ye(e, t, n, r)
    }
    ...
    ye(we, je, {
        ...
        return 1 === arguments.length ? function (e) {
            ...
            var t = (e = e.rgb()).r / 255,
                ...
                c = a - i,
                u = (a + i) / 2;
            return c ? (o = t === a ? (n - r) / c + 6 * (n < r) : n === a ? (r - t) / c + 2 : (t - n) / c + 4, c /= u < .5 ? a + i : 2 - a - i, o *= 60) : c = 0 < u && u < 1 ? 0 : o, new Ye(o, c, u, e.opacity)
        }(e) : new Ye(e, t, n, null == r ? 1 : r)
    }, _e(we, {
        brighter: function (e) {
            return e = null == e ? xe : Math.pow(xe, e), new Ye(this.h, this.s, this.l * e, this.opacity)
        },
        darker: function (e) {
    ...
    var Ct, Et, Mt, At, Dt = 180 / Math.PI,
        Ut = {
            translateX: 0,
            translateY: 0,
            rotate: 0,
    ...
    var Ft = Ot(function (e) {
            return "none" === e ? Ut : (Ct || (Ct = document.createElement("DIV"), Et = document.documentElement, Mt = document.defaultView), Ct.style.transform = e, e = Mt.getComputedStyle(Et.appendChild(Ct), null).getPropertyValue("transform"), Et.removeChild(Ct), Nt(+(e = e.slice(7, -1).split(","))[0], +e[1], +e[2], +e[3], +e[4], +e[5]))
        }, "px, ", "px)", "deg)"),
        jt = Ot(function (e) {
            return null == e ? Ut : (At || (At = document.createElementNS("http://www.w3.org/2000/svg", "g")), At.setAttribute("transform", e), (e = At.transform.baseVal.consolidate()) ? Nt((e = e.matrix).a, e.b, e.c, e.d, e.e, e.f) : Ut)
        }, ", ", ")", ")");
    Math.SQRT2;
    ...
    function tn(e) {
        It || (qt && (qt = clearTimeout(qt)), 24 < e - Vt ? (e < 1 / 0 && (qt = setTimeout(Kt, e - Wt.now() - Xt)), Bt && (Bt = clearInterval(Bt))) : (Bt || (zt = Wt.now(), Bt = setInterval(en, Yt)), It = 1, $t(Kt)))
    }
    ...
    var Nn = function (e, t, n) {
        var r = new Dn(null == t ? Mn : t, null == n ? An : n, NaN, NaN, NaN, NaN);
    ...
    Nn.copy = function () {
        ...
        var r, i, a, o, c, u, f, s = this._x0,
            ...
            p = [],
            b = this._root;
        for (b && p.push(new En(b, s, l, d, h)), null == n ? n = 1 / 0 : (s = e - n, l = t - n, d = e + n, h = t + n, n *= n); u = p.pop();)
            if (!(!(b = u.node) || (i = u.x0) > d || (a = u.y0) > h || (o = u.x1) < s || (c = u.y1) < l))
                if (b.length) {
                    var g = (i + o) / 2,
                        v = (a + c) / 2;
                    p.push(new En(b[3], g, v, o, c), new En(b[2], i, v, g, c), new En(b[1], g, a, o, v), new En(b[0], i, a, g, v)), (f = (v <= t) << 1 | g <= e) && (u = p[p.length - 1], p[p.length - 1] = p[p.length - 1 - f], p[p.length - 1 - f] = u)
                } else {
        ...
        var t, n, r, i, a, o, c = [],
            u = this._root;
        for (u && c.push(new En(u, this._x0, this._y0, this._x1, this._y1)); t = c.pop();)
            if (!e(u = t.node, r = t.x0, i = t.y0, a = t.x1, o = t.y1) && u.length) {
                var f = (r + a) / 2,
                    s = (i + o) / 2;
                (n = u[3]) && c.push(new En(n, f, s, a, o)), (n = u[2]) && c.push(new En(n, r, s, f, o)), (n = u[1]) && c.push(new En(n, f, i, a, s)), (n = u[0]) && c.push(new En(n, r, i, f, s))
            } return this
    }, Nn.visitAfter = function (e) {
        var t, n = [],
            r = [];
        for (this._root && n.push(new En(this._root, this._x0, this._y0, this._x1, this._y1)); t = n.pop();) {
            var i = t.node;
            if (i.length) {
                var a, o = t.x0,
                    c = t.y0,
                    ...
                    s = (o + u) / 2,
                    l = (c + f) / 2;
                (a = i[0]) && n.push(new En(a, o, c, s, l)), (a = i[1]) && n.push(new En(a, s, c, u, l)), (a = i[2]) && n.push(new En(a, o, l, s, f)), (a = i[3]) && n.push(new En(a, s, l, u, f))
            }
            r.push(t)
        }
    ...
    var Ln = {
        ...
        s: function (e, t) {
            ...
            var r = n[0],
                ...
                o = r.length;
            return a === o ? r : o < a ? r + new Array(a - o + 1).join("0") : 0 < a ? r.slice(0, a) + "." + r.slice(a) : "0." + new Array(1 - a).join("0") + On(e, Math.max(0, t + a - 1))[0]
        },
        X: function (e) {
    ...
    var qn, Bn = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
            ...
            function n(e) {
                ...
                if ("c" === v) a = _(e) + a, e = "";
                    ...
                    if (e = _(Math.abs(e), b), g && (e = function (e) {
                        ...
                        }(e)), o && 0 == +e && (o = !1), i = (o ? "(" === l ? l : "-" : "-" === l || "(" === l ? "" : l) + i, a = ("s" === v ? Bn[8 + Fn / 3] : "") + a + (o && "(" === l ? ")" : ""), w)
            ...
            formatPrefix: function (e, t) {
                var n = o(((e = Hn(e)).type = "f", e)),
                    r = 3 * Math.max(-8, Math.min(8, Math.floor(function (e) {
                        return (e = On(Math.abs(e))) ? e[1] : NaN
                    }(t) / 3))),
                    i = Math.pow(10, -r),
                    a = Bn[8 + r / 3];
                return function (e) {
    ...
    qn = Yn({
        ...
        grouping: [3],
        currency: ["$", ""]
    }), qn.format, qn.formatPrefix;
    var Vn, Xn, Wn;
    1 === (Xn = zn).length && (Vn = Xn, Xn = function (e, t) {
        return zn(Vn(e), t)
    }), Math.PI, Math.SQRT2;
    ...
    var Zn = {
            ...
            s: function (e, t) {
                ...
                var r = n[0],
                    ...
                    o = r.length;
                return a === o ? r : o < a ? r + new Array(a - o + 1).join("0") : 0 < a ? r.slice(0, a) + "." + r.slice(a) : "0." + new Array(1 - a).join("0") + $n(e, Math.max(0, t + a - 1))[0]
            },
            X: function (e) {
                return Math.round(e).toString(16).toUpperCase()
            },
    ...
    function Kn(e) {
        if (!(t = Gn.exec(e))) throw new Error("invalid format: " + e);
        var t, n = t[1] || " ",
            r = t[2] || ">",
            i = t[3] || "-",
            a = t[4] || "",
            ...
            f = t[8] && +t[8].slice(1),
            s = t[9] || "";
        "n" === s ? (u = !0, s = "g") : Zn[s] || (s = ""), (o || "0" === n && "=" === r) && (o = !0, n = "0", r = "="), this.fill = n, this.align = r, this.sign = i, this.symbol = a, this.zero = o, this.width = c, this.comma = u, this.precision = f, this.type = s
    }

    function er(e) {
        return e
    }
    Qn.prototype = Kn.prototype, Kn.prototype.toString = function () {
        return this.fill + this.align + this.sign + this.symbol + (this.zero ? "0" : "") + (null == this.width ? "" : Math.max(1, 0 | this.width)) + (this.comma ? "," : "") + (null == this.precision ? "" : "." + Math.max(0, 0 | this.precision)) + this.type
    };
    var tr, nr = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
    ...
    function rr(e) {
        ...
        function o(e) {
            ...
            function n(e) {
                ...
                if ("c" === g) a = y(e) + a, e = "";
                    ...
                    var o = (e = +e) < 0;
                    if (e = y(Math.abs(e), b), o && 0 == +e && (o = !1), i = (o ? "(" === l ? l : "-" : "-" === l || "(" === l ? "" : l) + i, a = a + ("s" === g ? nr[8 + Wn / 3] : "") + (o && "(" === l ? ")" : ""), _)
                        for (t = -1, n = e.length; ++t < n;)
                            if ((r = e.charCodeAt(t)) < 48 || 57 < r) {
        ...
        return {
            format: o,
            formatPrefix: function (e, t) {
                var n = o(((e = Qn(e)).type = "f", e)),
                    r = 3 * Math.max(-8, Math.min(8, Math.floor(function (e) {
                        return (e = $n(Math.abs(e))) ? e[1] : NaN
                    }(t) / 3))),
                    i = Math.pow(10, -r),
                    a = nr[8 + r / 3];
                return function (e) {
    ...
    function or(i, a, n, r) {
        ...
        return (o.floor = o).ceil = function (e) {
            ...
            return ir.setTime(+e), ar.setTime(+t), i(ir), i(ar), Math.floor(n(ir, ar))
        }, o.every = function (t) {
    ...
    var cr = or(function () {}, function (e, t) {
        e.setTime(+e + t)
    }, function (e, t) {
        return t - e
    });
    cr.every = function (n) {
        return n = Math.floor(n), isFinite(n) && 0 < n ? 1 < n ? or(function (e) {
    ...
    var ur = 6e4,
        ...
        sr = (or(function (e) {
            ...
            var t = e.getTimezoneOffset() * ur % fr;
            t < 0 && (t += fr), e.setTime(Math.floor((+e - t) / fr) * fr + t)
        }, function (e, t) {
            e.setTime(+e + t * fr)
        }, function (e, t) {
            return (t - e) / fr
            ...
            return (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * ur) / 864e5
        }, function (e) {
            return e.getDate() - 1
        }));
    ...
    function lr(t) {
        return or(function (e) {
            ...
            return (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * ur) / 6048e5
        })
    }
    var dr = lr(0),
        hr = lr(1),
        pr = (lr(2), lr(3), lr(4)),
        br = (lr(5), lr(6), or(function (e) {
    ...
    br.every = function (n) {
        return isFinite(n = Math.floor(n)) && 0 < n ? or(function (e) {
    ...
    var kr, Cr, Er, Mr, Ar, Dr, Ur, Nr, Or, Fr, jr, Hr, Rr, Pr, Lr, Ir, qr, Br, Yr, zr, Vr, Xr, Wr, $r, Jr, Zr = {
            "-": "",
            _: " ",
            0: "0"
        },
    ...
    function ni(e) {
        return new RegExp("^(?:" + e.map(ti).join("|") + ")", "i")
    }
    ...
    function yi(e, t, n) {
        var r = Gr.exec(t.slice(n, n + 6));
        return r ? (e.L = Math.floor(r[0] / 1e3), n + r[0].length) : -1
    }

    function _i(e, t, n) {
        var r = Qr.exec(t.slice(n, n + 1));
        return r ? n + r[0].length : -1
    }

    function wi(e, t, n) {
        var r = Gr.exec(t.slice(n));
    ...
    function Ti(e, t) {
        return ei(e.getDate(), t, 2)
    }

    function Si(e, t) {
        return ei(e.getHours(), t, 2)
    }

    function ki(e, t) {
        return ei(e.getHours() % 12 || 12, t, 2)
    }

    function Ci(e, t) {
        return ei(1 + sr.count(br(e), e), t, 3)
    }

    function Ei(e, t) {
        return ei(e.getMilliseconds(), t, 3)
    }
    ...
    function Ai(e, t) {
        return ei(e.getMonth() + 1, t, 2)
    }

    function Di(e, t) {
        return ei(e.getMinutes(), t, 2)
    }

    function Ui(e, t) {
        return ei(e.getSeconds(), t, 2)
    }
    ...
    function Oi(e, t) {
        return ei(dr.count(br(e), e), t, 2)
    }

    function Fi(e, t) {
        var n = e.getDay();
        return e = 4 <= n || 0 === n ? pr(e) : pr.ceil(e), ei(pr.count(br(e), e) + (4 === br(e).getDay()), t, 2)
    }
    ...
    function Hi(e, t) {
        return ei(hr.count(br(e), e), t, 2)
    }

    function Ri(e, t) {
        return ei(e.getFullYear() % 100, t, 2)
    }

    function Pi(e, t) {
        return ei(e.getFullYear() % 1e4, t, 4)
    }

    function Li(e) {
        var t = e.getTimezoneOffset();
        return (0 < t ? "-" : (t *= -1, "+")) + ei(t / 60 | 0, "0", 2) + ei(t % 60, "0", 2)
    }

    function Ii(e, t) {
        return ei(e.getUTCDate(), t, 2)
    }

    function qi(e, t) {
        return ei(e.getUTCHours(), t, 2)
    }

    function Bi(e, t) {
        return ei(e.getUTCHours() % 12 || 12, t, 2)
    }

    function Yi(e, t) {
        return ei(1 + gr.count(wr(e), e), t, 3)
    }

    function zi(e, t) {
        return ei(e.getUTCMilliseconds(), t, 3)
    }
    ...
    function Xi(e, t) {
        return ei(e.getUTCMonth() + 1, t, 2)
    }

    function Wi(e, t) {
        return ei(e.getUTCMinutes(), t, 2)
    }

    function $i(e, t) {
        return ei(e.getUTCSeconds(), t, 2)
    }
    ...
    function Zi(e, t) {
        return ei(mr.count(wr(e), e), t, 2)
    }

    function Gi(e, t) {
        var n = e.getUTCDay();
        return e = 4 <= n || 0 === n ? _r(e) : _r.ceil(e), ei(_r.count(wr(e), e) + (4 === wr(e).getUTCDay()), t, 2)
    }
    ...
    function Ki(e, t) {
        return ei(yr.count(wr(e), e), t, 2)
    }

    function ea(e, t) {
        return ei(e.getUTCFullYear() % 100, t, 2)
    }

    function ta(e, t) {
        return ei(e.getUTCFullYear() % 1e4, t, 4)
    }
    ...
    function oa(u, f) {
        return function (e) {
            var t, n, r, i = [],
                ...
                o = 0,
                c = u.length;
            for (e instanceof Date || (e = new Date(+e)); ++a < c;) 37 === u.charCodeAt(a) && (i.push(u.slice(o, a)), null != (n = Zr[t = u.charAt(++a)]) ? t = u.charAt(++a) : n = "e" === t ? " " : "0", (r = f[t]) && (t = r(e, n)), i.push(t), o = a + 1);
    ...
    function ca(i, a) {
        return function (e) {
            var t, n, r = Sr(1900);
            if (ua(r, i, e += "", 0) != e.length) return null;
            if ("Q" in r) return new Date(r.Q);
            if ("p" in r && (r.H = r.H % 12 + 12 * r.p), "V" in r) {
                if (r.V < 1 || 53 < r.V) return null;
                "w" in r || (r.w = 1), "Z" in r ? (t = 4 < (n = (t = Tr(Sr(r.y))).getUTCDay()) || 0 === n ? yr.ceil(t) : yr(t), t = gr.offset(t, 7 * (r.V - 1)), r.y = t.getUTCFullYear(), r.m = t.getUTCMonth(), r.d = t.getUTCDate() + (r.w + 6) % 7) : (t = 4 < (n = (t = a(Sr(r.y))).getDay()) || 0 === n ? hr.ceil(t) : hr(t), t = sr.offset(t, 7 * (r.V - 1)), r.y = t.getFullYear(), r.m = t.getMonth(), r.d = t.getDate() + (r.w + 6) % 7)
            } else("W" in r || "U" in r) && ("w" in r || (r.w = "u" in r ? r.u % 7 : "W" in r ? 1 : 0), n = "Z" in r ? Tr(Sr(r.y)).getUTCDay() : a(Sr(r.y)).getDay(), r.m = 0, r.d = "W" in r ? (r.w + 6) % 7 + 7 * r.W - (n + 5) % 7 : r.w + 7 * r.U - (n + 6) % 7);
            return "Z" in r ? (r.H += r.Z / 100 | 0, r.M += r.Z % 100, Tr(r)) : a(r)
        }
    }
    ...
    function ua(e, t, n, r) {
        for (var i, a, o = 0, c = t.length, u = n.length; o < c;) {
            ...
            if (37 === (i = t.charCodeAt(o++))) {
                if (i = t.charAt(o++), !(a = Jr[i in Zr ? t.charAt(o++) : i]) || (r = a(e, n, r)) < 0) return -1
    ...
    Ar = (Mr = {
    ...
    }).dateTime, Dr = Mr.date, Ur = Mr.time, Nr = Mr.periods, Or = Mr.days, Fr = Mr.shortDays, jr = Mr.months, Hr = Mr.shortMonths, Rr = ni(Nr), Pr = ri(Nr), Lr = ni(Or), Ir = ri(Or), qr = ni(Fr), Br = ri(Fr), Yr = ni(jr), zr = ri(jr), Vr = ni(Hr), Xr = ri(Hr), $r = {
        a: function (e) {
            return Fr[e.getUTCDay()]
        },
        A: function (e) {
            return Or[e.getUTCDay()]
        },
        b: function (e) {
            return Hr[e.getUTCMonth()]
        },
        B: function (e) {
            return jr[e.getUTCMonth()]
        },
        c: null,
        d: Ii,
        e: Ii,
        ...
        a: function (e, t, n) {
            ...
            return r ? (e.w = Br[r[0].toLowerCase()], n + r[0].length) : -1
        },
        A: function (e, t, n) {
            var r = Lr.exec(t.slice(n));
            return r ? (e.w = Ir[r[0].toLowerCase()], n + r[0].length) : -1
        },
        b: function (e, t, n) {
            var r = Vr.exec(t.slice(n));
            return r ? (e.m = Xr[r[0].toLowerCase()], n + r[0].length) : -1
        },
        B: function (e, t, n) {
            var r = Yr.exec(t.slice(n));
        ...
        p: function (e, t, n) {
            ...
            return r ? (e.p = Pr[r[0].toLowerCase()], n + r[0].length) : -1
        },
        Q: wi,
        s: xi,
        S: vi,
        ...
        b: function (e) {
            return Hr[e.getMonth()]
        },
        B: function (e) {
            return jr[e.getMonth()]
        },
        c: null,
        d: Ti,
        e: Ti,
        ...
        Z: Li,
        "%": ra
    }).x = oa(Dr, Wr), Wr.X = oa(Ur, Wr), Wr.c = oa(Ar, Wr), $r.x = oa(Dr, $r), $r.X = oa(Ur, $r), $r.c = oa(Ar, $r), kr = {
        format: function (e) {
            var t = oa(e += "", Wr);
    ...
    }, kr.parse, Cr = kr.utcFormat, Er = kr.utcParse;
    var fa = "%Y-%m-%dT%H:%M:%S.%LZ";
    Date.prototype.toISOString || Cr(fa); + new Date("2000-01-01T00:00:00.000Z") || Er(fa);
    ...
    sa("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"), sa("7fc97fbeaed4fdc086ffff99386cb0f0027fbf5b17666666"), sa("1b9e77d95f027570b3e7298a66a61ee6ab02a6761d666666"), sa("a6cee31f78b4b2df8a33a02cfb9a99e31a1cfdbf6fff7f00cab2d66a3d9affff99b15928"), sa("fbb4aeb3cde3ccebc5decbe4fed9a6ffffcce5d8bdfddaecf2f2f2"), sa("b3e2cdfdcdaccbd5e8f4cae4e6f5c9fff2aef1e2cccccccc"), sa("e41a1c377eb84daf4a984ea3ff7f00ffff33a65628f781bf999999"), sa("66c2a5fc8d628da0cbe78ac3a6d854ffd92fe5c494b3b3b3"), sa("8dd3c7ffffb3bebadafb807280b1d3fdb462b3de69fccde5d9d9d9bc80bdccebc5ffed6f"), la(new Array(3).concat("d8b365f5f5f55ab4ac", "a6611adfc27d80cdc1018571", "a6611adfc27df5f5f580cdc1018571", "8c510ad8b365f6e8c3c7eae55ab4ac01665e", "8c510ad8b365f6e8c3f5f5f5c7eae55ab4ac01665e", "8c510abf812ddfc27df6e8c3c7eae580cdc135978f01665e", "8c510abf812ddfc27df6e8c3f5f5f5c7eae580cdc135978f01665e", "5430058c510abf812ddfc27df6e8c3c7eae580cdc135978f01665e003c30", "5430058c510abf812ddfc27df6e8c3f5f5f5c7eae580cdc135978f01665e003c30").map(sa)), la(new Array(3).concat("af8dc3f7f7f77fbf7b", "7b3294c2a5cfa6dba0008837", "7b3294c2a5cff7f7f7a6dba0008837", "762a83af8dc3e7d4e8d9f0d37fbf7b1b7837", "762a83af8dc3e7d4e8f7f7f7d9f0d37fbf7b1b7837", "762a839970abc2a5cfe7d4e8d9f0d3a6dba05aae611b7837", "762a839970abc2a5cfe7d4e8f7f7f7d9f0d3a6dba05aae611b7837", "40004b762a839970abc2a5cfe7d4e8d9f0d3a6dba05aae611b783700441b", "40004b762a839970abc2a5cfe7d4e8f7f7f7d9f0d3a6dba05aae611b783700441b").map(sa)), la(new Array(3).concat("e9a3c9f7f7f7a1d76a", "d01c8bf1b6dab8e1864dac26", "d01c8bf1b6daf7f7f7b8e1864dac26", "c51b7de9a3c9fde0efe6f5d0a1d76a4d9221", "c51b7de9a3c9fde0eff7f7f7e6f5d0a1d76a4d9221", "c51b7dde77aef1b6dafde0efe6f5d0b8e1867fbc414d9221", "c51b7dde77aef1b6dafde0eff7f7f7e6f5d0b8e1867fbc414d9221", "8e0152c51b7dde77aef1b6dafde0efe6f5d0b8e1867fbc414d9221276419", "8e0152c51b7dde77aef1b6dafde0eff7f7f7e6f5d0b8e1867fbc414d9221276419").map(sa)), la(new Array(3).concat("998ec3f7f7f7f1a340", "5e3c99b2abd2fdb863e66101", "5e3c99b2abd2f7f7f7fdb863e66101", "542788998ec3d8daebfee0b6f1a340b35806", "542788998ec3d8daebf7f7f7fee0b6f1a340b35806", "5427888073acb2abd2d8daebfee0b6fdb863e08214b35806", "5427888073acb2abd2d8daebf7f7f7fee0b6fdb863e08214b35806", "2d004b5427888073acb2abd2d8daebfee0b6fdb863e08214b358067f3b08", "2d004b5427888073acb2abd2d8daebf7f7f7fee0b6fdb863e08214b358067f3b08").map(sa)), la(new Array(3).concat("ef8a62f7f7f767a9cf", "ca0020f4a58292c5de0571b0", "ca0020f4a582f7f7f792c5de0571b0", "b2182bef8a62fddbc7d1e5f067a9cf2166ac", "b2182bef8a62fddbc7f7f7f7d1e5f067a9cf2166ac", "b2182bd6604df4a582fddbc7d1e5f092c5de4393c32166ac", "b2182bd6604df4a582fddbc7f7f7f7d1e5f092c5de4393c32166ac", "67001fb2182bd6604df4a582fddbc7d1e5f092c5de4393c32166ac053061", "67001fb2182bd6604df4a582fddbc7f7f7f7d1e5f092c5de4393c32166ac053061").map(sa)), la(new Array(3).concat("ef8a62ffffff999999", "ca0020f4a582bababa404040", "ca0020f4a582ffffffbababa404040", "b2182bef8a62fddbc7e0e0e09999994d4d4d", "b2182bef8a62fddbc7ffffffe0e0e09999994d4d4d", "b2182bd6604df4a582fddbc7e0e0e0bababa8787874d4d4d", "b2182bd6604df4a582fddbc7ffffffe0e0e0bababa8787874d4d4d", "67001fb2182bd6604df4a582fddbc7e0e0e0bababa8787874d4d4d1a1a1a", "67001fb2182bd6604df4a582fddbc7ffffffe0e0e0bababa8787874d4d4d1a1a1a").map(sa)), la(new Array(3).concat("fc8d59ffffbf91bfdb", "d7191cfdae61abd9e92c7bb6", "d7191cfdae61ffffbfabd9e92c7bb6", "d73027fc8d59fee090e0f3f891bfdb4575b4", "d73027fc8d59fee090ffffbfe0f3f891bfdb4575b4", "d73027f46d43fdae61fee090e0f3f8abd9e974add14575b4", "d73027f46d43fdae61fee090ffffbfe0f3f8abd9e974add14575b4", "a50026d73027f46d43fdae61fee090e0f3f8abd9e974add14575b4313695", "a50026d73027f46d43fdae61fee090ffffbfe0f3f8abd9e974add14575b4313695").map(sa)), la(new Array(3).concat("fc8d59ffffbf91cf60", "d7191cfdae61a6d96a1a9641", "d7191cfdae61ffffbfa6d96a1a9641", "d73027fc8d59fee08bd9ef8b91cf601a9850", "d73027fc8d59fee08bffffbfd9ef8b91cf601a9850", "d73027f46d43fdae61fee08bd9ef8ba6d96a66bd631a9850", "d73027f46d43fdae61fee08bffffbfd9ef8ba6d96a66bd631a9850", "a50026d73027f46d43fdae61fee08bd9ef8ba6d96a66bd631a9850006837", "a50026d73027f46d43fdae61fee08bffffbfd9ef8ba6d96a66bd631a9850006837").map(sa)), la(new Array(3).concat("fc8d59ffffbf99d594", "d7191cfdae61abdda42b83ba", "d7191cfdae61ffffbfabdda42b83ba", "d53e4ffc8d59fee08be6f59899d5943288bd", "d53e4ffc8d59fee08bffffbfe6f59899d5943288bd", "d53e4ff46d43fdae61fee08be6f598abdda466c2a53288bd", "d53e4ff46d43fdae61fee08bffffbfe6f598abdda466c2a53288bd", "9e0142d53e4ff46d43fdae61fee08be6f598abdda466c2a53288bd5e4fa2", "9e0142d53e4ff46d43fdae61fee08bffffbfe6f598abdda466c2a53288bd5e4fa2").map(sa)), la(new Array(3).concat("e5f5f999d8c92ca25f", "edf8fbb2e2e266c2a4238b45", "edf8fbb2e2e266c2a42ca25f006d2c", "edf8fbccece699d8c966c2a42ca25f006d2c", "edf8fbccece699d8c966c2a441ae76238b45005824", "f7fcfde5f5f9ccece699d8c966c2a441ae76238b45005824", "f7fcfde5f5f9ccece699d8c966c2a441ae76238b45006d2c00441b").map(sa)), la(new Array(3).concat("e0ecf49ebcda8856a7", "edf8fbb3cde38c96c688419d", "edf8fbb3cde38c96c68856a7810f7c", "edf8fbbfd3e69ebcda8c96c68856a7810f7c", "edf8fbbfd3e69ebcda8c96c68c6bb188419d6e016b", "f7fcfde0ecf4bfd3e69ebcda8c96c68c6bb188419d6e016b", "f7fcfde0ecf4bfd3e69ebcda8c96c68c6bb188419d810f7c4d004b").map(sa)), la(new Array(3).concat("e0f3dba8ddb543a2ca", "f0f9e8bae4bc7bccc42b8cbe", "f0f9e8bae4bc7bccc443a2ca0868ac", "f0f9e8ccebc5a8ddb57bccc443a2ca0868ac", "f0f9e8ccebc5a8ddb57bccc44eb3d32b8cbe08589e", "f7fcf0e0f3dbccebc5a8ddb57bccc44eb3d32b8cbe08589e", "f7fcf0e0f3dbccebc5a8ddb57bccc44eb3d32b8cbe0868ac084081").map(sa)), la(new Array(3).concat("fee8c8fdbb84e34a33", "fef0d9fdcc8afc8d59d7301f", "fef0d9fdcc8afc8d59e34a33b30000", "fef0d9fdd49efdbb84fc8d59e34a33b30000", "fef0d9fdd49efdbb84fc8d59ef6548d7301f990000", "fff7ecfee8c8fdd49efdbb84fc8d59ef6548d7301f990000", "fff7ecfee8c8fdd49efdbb84fc8d59ef6548d7301fb300007f0000").map(sa)), la(new Array(3).concat("ece2f0a6bddb1c9099", "f6eff7bdc9e167a9cf02818a", "f6eff7bdc9e167a9cf1c9099016c59", "f6eff7d0d1e6a6bddb67a9cf1c9099016c59", "f6eff7d0d1e6a6bddb67a9cf3690c002818a016450", "fff7fbece2f0d0d1e6a6bddb67a9cf3690c002818a016450", "fff7fbece2f0d0d1e6a6bddb67a9cf3690c002818a016c59014636").map(sa)), la(new Array(3).concat("ece7f2a6bddb2b8cbe", "f1eef6bdc9e174a9cf0570b0", "f1eef6bdc9e174a9cf2b8cbe045a8d", "f1eef6d0d1e6a6bddb74a9cf2b8cbe045a8d", "f1eef6d0d1e6a6bddb74a9cf3690c00570b0034e7b", "fff7fbece7f2d0d1e6a6bddb74a9cf3690c00570b0034e7b", "fff7fbece7f2d0d1e6a6bddb74a9cf3690c00570b0045a8d023858").map(sa)), la(new Array(3).concat("e7e1efc994c7dd1c77", "f1eef6d7b5d8df65b0ce1256", "f1eef6d7b5d8df65b0dd1c77980043", "f1eef6d4b9dac994c7df65b0dd1c77980043", "f1eef6d4b9dac994c7df65b0e7298ace125691003f", "f7f4f9e7e1efd4b9dac994c7df65b0e7298ace125691003f", "f7f4f9e7e1efd4b9dac994c7df65b0e7298ace125698004367001f").map(sa)), la(new Array(3).concat("fde0ddfa9fb5c51b8a", "feebe2fbb4b9f768a1ae017e", "feebe2fbb4b9f768a1c51b8a7a0177", "feebe2fcc5c0fa9fb5f768a1c51b8a7a0177", "feebe2fcc5c0fa9fb5f768a1dd3497ae017e7a0177", "fff7f3fde0ddfcc5c0fa9fb5f768a1dd3497ae017e7a0177", "fff7f3fde0ddfcc5c0fa9fb5f768a1dd3497ae017e7a017749006a").map(sa)), la(new Array(3).concat("edf8b17fcdbb2c7fb8", "ffffcca1dab441b6c4225ea8", "ffffcca1dab441b6c42c7fb8253494", "ffffccc7e9b47fcdbb41b6c42c7fb8253494", "ffffccc7e9b47fcdbb41b6c41d91c0225ea80c2c84", "ffffd9edf8b1c7e9b47fcdbb41b6c41d91c0225ea80c2c84", "ffffd9edf8b1c7e9b47fcdbb41b6c41d91c0225ea8253494081d58").map(sa)), la(new Array(3).concat("f7fcb9addd8e31a354", "ffffccc2e69978c679238443", "ffffccc2e69978c67931a354006837", "ffffccd9f0a3addd8e78c67931a354006837", "ffffccd9f0a3addd8e78c67941ab5d238443005a32", "ffffe5f7fcb9d9f0a3addd8e78c67941ab5d238443005a32", "ffffe5f7fcb9d9f0a3addd8e78c67941ab5d238443006837004529").map(sa)), la(new Array(3).concat("fff7bcfec44fd95f0e", "ffffd4fed98efe9929cc4c02", "ffffd4fed98efe9929d95f0e993404", "ffffd4fee391fec44ffe9929d95f0e993404", "ffffd4fee391fec44ffe9929ec7014cc4c028c2d04", "ffffe5fff7bcfee391fec44ffe9929ec7014cc4c028c2d04", "ffffe5fff7bcfee391fec44ffe9929ec7014cc4c02993404662506").map(sa)), la(new Array(3).concat("ffeda0feb24cf03b20", "ffffb2fecc5cfd8d3ce31a1c", "ffffb2fecc5cfd8d3cf03b20bd0026", "ffffb2fed976feb24cfd8d3cf03b20bd0026", "ffffb2fed976feb24cfd8d3cfc4e2ae31a1cb10026", "ffffccffeda0fed976feb24cfd8d3cfc4e2ae31a1cb10026", "ffffccffeda0fed976feb24cfd8d3cfc4e2ae31a1cbd0026800026").map(sa)), la(new Array(3).concat("deebf79ecae13182bd", "eff3ffbdd7e76baed62171b5", "eff3ffbdd7e76baed63182bd08519c", "eff3ffc6dbef9ecae16baed63182bd08519c", "eff3ffc6dbef9ecae16baed64292c62171b5084594", "f7fbffdeebf7c6dbef9ecae16baed64292c62171b5084594", "f7fbffdeebf7c6dbef9ecae16baed64292c62171b508519c08306b").map(sa)), la(new Array(3).concat("e5f5e0a1d99b31a354", "edf8e9bae4b374c476238b45", "edf8e9bae4b374c47631a354006d2c", "edf8e9c7e9c0a1d99b74c47631a354006d2c", "edf8e9c7e9c0a1d99b74c47641ab5d238b45005a32", "f7fcf5e5f5e0c7e9c0a1d99b74c47641ab5d238b45005a32", "f7fcf5e5f5e0c7e9c0a1d99b74c47641ab5d238b45006d2c00441b").map(sa)), la(new Array(3).concat("f0f0f0bdbdbd636363", "f7f7f7cccccc969696525252", "f7f7f7cccccc969696636363252525", "f7f7f7d9d9d9bdbdbd969696636363252525", "f7f7f7d9d9d9bdbdbd969696737373525252252525", "fffffff0f0f0d9d9d9bdbdbd969696737373525252252525", "fffffff0f0f0d9d9d9bdbdbd969696737373525252252525000000").map(sa)), la(new Array(3).concat("efedf5bcbddc756bb1", "f2f0f7cbc9e29e9ac86a51a3", "f2f0f7cbc9e29e9ac8756bb154278f", "f2f0f7dadaebbcbddc9e9ac8756bb154278f", "f2f0f7dadaebbcbddc9e9ac8807dba6a51a34a1486", "fcfbfdefedf5dadaebbcbddc9e9ac8807dba6a51a34a1486", "fcfbfdefedf5dadaebbcbddc9e9ac8807dba6a51a354278f3f007d").map(sa)), la(new Array(3).concat("fee0d2fc9272de2d26", "fee5d9fcae91fb6a4acb181d", "fee5d9fcae91fb6a4ade2d26a50f15", "fee5d9fcbba1fc9272fb6a4ade2d26a50f15", "fee5d9fcbba1fc9272fb6a4aef3b2ccb181d99000d", "fff5f0fee0d2fcbba1fc9272fb6a4aef3b2ccb181d99000d", "fff5f0fee0d2fcbba1fc9272fb6a4aef3b2ccb181da50f1567000d").map(sa)), la(new Array(3).concat("fee6cefdae6be6550d", "feeddefdbe85fd8d3cd94701", "feeddefdbe85fd8d3ce6550da63603", "feeddefdd0a2fdae6bfd8d3ce6550da63603", "feeddefdd0a2fdae6bfd8d3cf16913d948018c2d04", "fff5ebfee6cefdd0a2fdae6bfd8d3cf16913d948018c2d04", "fff5ebfee6cefdd0a2fdae6bfd8d3cf16913d94801a636037f2704").map(sa)), Lt(pt(300, .5, 0), pt(-240, .5, 1));
    ...
    da(sa(""));
    da(sa("")), da(sa("")), da(sa("")), Math.PI;
    ...
    function pa(e, t, n) {
        var r = e._x1 - e._x0,
            ...
            o = (n - e._y1) / (i || r < 0 && -0),
            c = (a * i + o * r) / (r + i);
        return (ha(a) + ha(o)) * Math.min(Math.abs(a), Math.abs(o), .5 * Math.abs(c)) || 0
    }
        ...
        lineEnd: function () {
            switch (this._point) {
                case 2:
                    ...
                    break;
                case 3:
                    va(this, this._t0, ba(this, this._t0))
            ...
            if (t = +t, (e = +e) !== this._x1 || t !== this._y1) {
                switch (this._point) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        this._point = 3, va(this, ba(this, n = pa(this, e, t)), n);
                        break;
                    default:
                        va(this, this._t0, n = pa(this, e, t))
                }
                this._x0 = this._x1, this._x1 = e, this._y0 = this._y1, this._y1 = t, this._t0 = n
            }
        }
    }, (function (e) {
        this._context = new ya(e)
    }.prototype = Object.create(ma.prototype)).point = function (e, t) {
    ...
    function xa(a, o, n, r) {
        ...
        return (c.floor = c).ceil = function (e) {
            ...
            return _a.setTime(+e), wa.setTime(+t), a(_a), a(wa), Math.floor(n(_a, wa))
        }, c.every = function (t) {
    ...
    var Ta = xa(function () {}, function (e, t) {
        e.setTime(+e + t)
    }, function (e, t) {
        return t - e
    });
    Ta.every = function (n) {
        return n = Math.floor(n), isFinite(n) && 0 < n ? 1 < n ? xa(function (e) {
            e.setTime(Math.floor(e / n) * n)
        }, function (e, t) {
            e.setTime(+e + t * n)
        }, function (e, t) {
    ...
    var Sa = 6e4,
        ...
        Ca = (xa(function (e) {
            ...
            var t = e.getTimezoneOffset() * Sa % ka;
            t < 0 && (t += ka), e.setTime(Math.floor((+e - t) / ka) * ka + t)
        }, function (e, t) {
            e.setTime(+e + t * ka)
        }, function (e, t) {
            return (t - e) / ka
            ...
            return (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * Sa) / 864e5
        }, function (e) {
            return e.getDate() - 1
        }));
    ...
    function Ea(t) {
        return xa(function (e) {
            ...
            return (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * Sa) / 6048e5
        })
    }
    var Ma = Ea(0),
        Aa = Ea(1),
        Da = (Ea(2), Ea(3), Ea(4)),
        Ua = (Ea(5), Ea(6), xa(function (e) {
            e.setDate(1), e.setHours(0, 0, 0, 0)
        }, function (e, t) {
            e.setMonth(e.getMonth() + t)
        }, function (e, t) {
    ...
    Ua.every = function (n) {
        return isFinite(n = Math.floor(n)) && 0 < n ? xa(function (e) {
            e.setFullYear(Math.floor(e.getFullYear() / n) * n), e.setMonth(0, 1), e.setHours(0, 0, 0, 0)
        }, function (e, t) {
            e.setFullYear(e.getFullYear() + t * n)
        }) : null
    ...
    var qa, Ba, Ya, za, Va, Xa, Wa, $a, Ja, Za, Ga, Qa, Ka, eo, to, no, ro, io, ao, oo, co, uo, fo, so, lo, ho = {
            "-": "",
            _: " ",
            0: "0"
        },
    ...
    function yo(e) {
        return new RegExp("^(?:" + e.map(mo).join("|") + ")", "i")
    }
    ...
    function Ho(e, t, n) {
        var r = po.exec(t.slice(n, n + 6));
        return r ? (e.L = Math.floor(r[0] / 1e3), n + r[0].length) : -1
    }

    function Ro(e, t, n) {
        var r = bo.exec(t.slice(n, n + 1));
        return r ? n + r[0].length : -1
    }

    function Po(e, t, n) {
        var r = po.exec(t.slice(n));
        return r ? (e.Q = +r[0], n + r[0].length) : -1
    }
    ...
    function Io(e, t) {
        return vo(e.getDate(), t, 2)
    }

    function qo(e, t) {
        return vo(e.getHours(), t, 2)
    }

    function Bo(e, t) {
        return vo(e.getHours() % 12 || 12, t, 2)
    }

    function Yo(e, t) {
        return vo(1 + Ca.count(Ua(e), e), t, 3)
    }

    function zo(e, t) {
        return vo(e.getMilliseconds(), t, 3)
    }
    ...
    function Xo(e, t) {
        return vo(e.getMonth() + 1, t, 2)
    }

    function Wo(e, t) {
        return vo(e.getMinutes(), t, 2)
    }

    function $o(e, t) {
        return vo(e.getSeconds(), t, 2)
    }
    ...
    function Zo(e, t) {
        return vo(Ma.count(Ua(e), e), t, 2)
    }

    function Go(e, t) {
        var n = e.getDay();
        return e = 4 <= n || 0 === n ? Da(e) : Da.ceil(e), vo(Da.count(Ua(e), e) + (4 === Ua(e).getDay()), t, 2)
    }
    ...
    function Ko(e, t) {
        return vo(Aa.count(Ua(e), e), t, 2)
    }

    function ec(e, t) {
        return vo(e.getFullYear() % 100, t, 2)
    }

    function tc(e, t) {
        return vo(e.getFullYear() % 1e4, t, 4)
    }

    function nc(e) {
        var t = e.getTimezoneOffset();
        return (0 < t ? "-" : (t *= -1, "+")) + vo(t / 60 | 0, "0", 2) + vo(t % 60, "0", 2)
    }

    function rc(e, t) {
        return vo(e.getUTCDate(), t, 2)
    }

    function ic(e, t) {
        return vo(e.getUTCHours(), t, 2)
    }

    function ac(e, t) {
        return vo(e.getUTCHours() % 12 || 12, t, 2)
    }

    function oc(e, t) {
        return vo(1 + Na.count(Ra(e), e), t, 3)
    }

    function cc(e, t) {
        return vo(e.getUTCMilliseconds(), t, 3)
    }
    ...
    function fc(e, t) {
        return vo(e.getUTCMonth() + 1, t, 2)
    }

    function sc(e, t) {
        return vo(e.getUTCMinutes(), t, 2)
    }

    function lc(e, t) {
        return vo(e.getUTCSeconds(), t, 2)
    }
    ...
    function hc(e, t) {
        return vo(Fa.count(Ra(e), e), t, 2)
    }

    function pc(e, t) {
        var n = e.getUTCDay();
        return e = 4 <= n || 0 === n ? Ha(e) : Ha.ceil(e), vo(Ha.count(Ra(e), e) + (4 === Ra(e).getUTCDay()), t, 2)
    }
    ...
    function gc(e, t) {
        return vo(ja.count(Ra(e), e), t, 2)
    }

    function vc(e, t) {
        return vo(e.getUTCFullYear() % 100, t, 2)
    }

    function mc(e, t) {
        return vo(e.getUTCFullYear() % 1e4, t, 4)
    }
    ...
    function Tc(u, f) {
        return function (e) {
            var t, n, r, i = [],
                ...
                o = 0,
                c = u.length;
            for (e instanceof Date || (e = new Date(+e)); ++a < c;) 37 === u.charCodeAt(a) && (i.push(u.slice(o, a)), null != (n = ho[t = u.charAt(++a)]) ? t = u.charAt(++a) : n = "e" === t ? " " : "0", (r = f[t]) && (t = r(e, n)), i.push(t), o = a + 1);
            return i.push(u.slice(o, a)), i.join("")
        }
    }
    ...
    function Sc(i, a) {
        return function (e) {
            var t, n, r = Ia(1900);
            if (kc(r, i, e += "", 0) != e.length) return null;
            if ("Q" in r) return new Date(r.Q);
            if ("p" in r && (r.H = r.H % 12 + 12 * r.p), "V" in r) {
                if (r.V < 1 || 53 < r.V) return null;
                "w" in r || (r.w = 1), "Z" in r ? (t = 4 < (n = (t = La(Ia(r.y))).getUTCDay()) || 0 === n ? ja.ceil(t) : ja(t), t = Na.offset(t, 7 * (r.V - 1)), r.y = t.getUTCFullYear(), r.m = t.getUTCMonth(), r.d = t.getUTCDate() + (r.w + 6) % 7) : (t = 4 < (n = (t = a(Ia(r.y))).getDay()) || 0 === n ? Aa.ceil(t) : Aa(t), t = Ca.offset(t, 7 * (r.V - 1)), r.y = t.getFullYear(), r.m = t.getMonth(), r.d = t.getDate() + (r.w + 6) % 7)
            } else("W" in r || "U" in r) && ("w" in r || (r.w = "u" in r ? r.u % 7 : "W" in r ? 1 : 0), n = "Z" in r ? La(Ia(r.y)).getUTCDay() : a(Ia(r.y)).getDay(), r.m = 0, r.d = "W" in r ? (r.w + 6) % 7 + 7 * r.W - (n + 5) % 7 : r.w + 7 * r.U - (n + 6) % 7);
            return "Z" in r ? (r.H += r.Z / 100 | 0, r.M += r.Z % 100, La(r)) : a(r)
        }
    }
    ...
    function kc(e, t, n, r) {
        for (var i, a, o = 0, c = t.length, u = n.length; o < c;) {
            if (u <= r) return -1;
            if (37 === (i = t.charCodeAt(o++))) {
                if (i = t.charAt(o++), !(a = lo[i in ho ? t.charAt(o++) : i]) || (r = a(e, n, r)) < 0) return -1
            } else if (i != n.charCodeAt(r++)) return -1
        }
        return r
    }
    Va = (za = {
        ...
        months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
        shortMonths: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
    }).dateTime, Xa = za.date, Wa = za.time, $a = za.periods, Ja = za.days, Za = za.shortDays, Ga = za.months, Qa = za.shortMonths, Ka = yo($a), eo = _o($a), to = yo(Ja), no = _o(Ja), ro = yo(Za), io = _o(Za), ao = yo(Ga), oo = _o(Ga), co = yo(Qa), uo = _o(Qa), so = {
        a: function (e) {
            return Za[e.getUTCDay()]
        },
        A: function (e) {
            return Ja[e.getUTCDay()]
        },
        b: function (e) {
            return Qa[e.getUTCMonth()]
        },
        B: function (e) {
            return Ga[e.getUTCMonth()]
        },
        c: null,
        d: rc,
        e: rc,
        ...
        a: function (e, t, n) {
            ...
            return r ? (e.w = io[r[0].toLowerCase()], n + r[0].length) : -1
        },
        A: function (e, t, n) {
            var r = to.exec(t.slice(n));
            return r ? (e.w = no[r[0].toLowerCase()], n + r[0].length) : -1
        },
        b: function (e, t, n) {
            var r = co.exec(t.slice(n));
            return r ? (e.m = uo[r[0].toLowerCase()], n + r[0].length) : -1
        },
        B: function (e, t, n) {
            var r = ao.exec(t.slice(n));
            return r ? (e.m = oo[r[0].toLowerCase()], n + r[0].length) : -1
        },
        c: function (e, t, n) {
            return kc(e, Va, t, n)
        },
        ...
        M: Oo,
        p: function (e, t, n) {
            var r = Ka.exec(t.slice(n));
            return r ? (e.p = eo[r[0].toLowerCase()], n + r[0].length) : -1
        },
        Q: Po,
        s: Lo,
        S: Fo,
        ...
        Z: nc,
        "%": _c
    }).x = Tc(Xa, fo), fo.X = Tc(Wa, fo), fo.c = Tc(Va, fo), so.x = Tc(Xa, so), so.X = Tc(Wa, so), so.c = Tc(Va, so), qa = {
        format: function (e) {
            var t = Tc(e += "", fo);
            return t.toString = function () {
                return e
    ...
    }, qa.parse, Ba = qa.utcFormat, Ya = qa.utcParse;
    var Cc = "%Y-%m-%dT%H:%M:%S.%LZ";
    Date.prototype.toISOString || Ba(Cc); + new Date("2000-01-01T00:00:00.000Z") || Ya(Cc);
    ...
    function Dc(e) {
        return e.map(function (e) {
            return null != e && "object" == typeof e && "map" in e ? Dc(e) : e
        })
    }
    ...
    Array.prototype.findIndex || Object.defineProperty(Array.prototype, "findIndex", {
        ...
        configurable: !0,
        writable: !0
    }), Ac.prototype.csv = function (n) {
        if (this.cached_data) n(void 0, Dc(this.cached_data));
        else {
            var r = this;
            x({
                ...
                callback: function (e, t) {
                    if (e) return n(e);
                    r.cached_data = g(t), n(void 0, Dc(r.cached_data))
                }
            }, "load-data")
        }
    }, Ac.prototype.saveData = function (e, n) {
        var r = this,
            i = Mc(Dc(e));
        x({
            url: this.api_prefix + "/" + this.id + "/csv",
    ...
    }, Ac.prototype.updateFromUrl = function (n, r) {
        var i = this;
        x({
            url: this.api_prefix + "/" + this.id + "/csv-url",
            payload: function () {
                return {
                    live_csv_url: n,
                    version_number: i.getVersionNumber()
                }
            },
            callback: function (e, t) {
                if (e) return r(e);
                i.setVersionNumber(t.version_number), (i.live_csv_url = n) ? i.updateFromLiveCsvUrl(function (e, t) {
                    if (e) return i.last_remote_data_error_message = e, r(e);
                    var n = function (e) {
                        return e.forEach(function (e) {
                            for (var t = 0; t < e.length; t++) e[t] && "string" == typeof e[t] && (e[t] = e[t].trim())
                        }), e
                    }(Mc(g(t.csv)));
                    i.cached_data = n, i.setVersionNumber(t.version_number), i.t_updated = t.t_updated, i.last_remote_data_error_message = null, r(void 0, n)
                }) : (i.t_updated = t.t_updated, i.last_remote_data_error_message = null, r(void 0, null))
            }
        })
    }, Ac.prototype.updateFromLiveCsvUrl = function (n) {
        var r = this;
        x({
            url: this.api_prefix + "/" + this.id + "/update-from-live-csv-url",
            payload: function () {
                return {
                    version_number: r.getVersionNumber()
                }
            ...
            callback: function (e, t) {
                if (e) return n(e);
                r.setVersionNumber(t.version_number), n(void 0, t)
            }
        })
    }, Ac.prototype.save = function (e, t) {
        return S(this, e, t)
    }, Ac.prototype.delete = function (e) {
        return k(this, e)
    }, Uc.prototype.getSettings = function (n) {
    ...
    }, Uc.prototype.getDataBindings = function (e) {
        x({
    ...
    }, Oc.prototype.setTemplateId = function (e, t) {
        S(this, {
            template_id: e
        }, t)
    }, Oc.prototype.getTemplate = function () {
        return this.template_id ? (this._template && this.template_id == this._template.id || (this._template = new Uc(this.template_id)), this._template) : null
    }, Oc.prototype.settingsForCurrentTemplate = function () {
        return this.settings && this.template_id in this.settings ? this.settings[this.template_id] : {}
    }, Oc.prototype.getState = function (a) {
        this.template_id || a({});
    ...
    }, Oc.prototype.resetToTheme = function (n) {
        var r = this;
        x({
    ...
    }, Oc.prototype.updateDataBindings = function (t, n) {
        var r = this;
        if (this.is_listed) return Fc(r, t, n);
        this.save({
            is_listed: !0
        }, function (e) {
            return e ? n(e) : Fc(r, t, n)
        })
    }, Oc.prototype.updateSettings = function (t, n) {
        var r = this;
        if (this.is_listed) return jc(r, t, n);
        this.save({
            is_listed: !0
        }, function (e) {
            return e ? n(e) : jc(r, t, n)
        })
    }, Oc.prototype.refreshSettings = function (n) {
        var r = this;
        x({
    ...
    }, Oc.prototype.getThemeFontsAndColors = function (n) {
        x({
    ...
    }, Oc.prototype.getDataTables = function (n) {
        x({
    ...
    }, Oc.prototype.dataTables = function (e) {
        var r = this;
    ...
    }, Oc.prototype.refreshDataTables = function () {
        this.data_tables = void 0, this.dataTablesHaveChanged()
    }, Oc.prototype.prepareData = function (f) {
        var s = this;
        ...
        k(this, e)
    }, Oc.prototype.createDataTable = function (t, n) {
        var r = this;
        if (this.is_listed) return Hc(r, t, n);
        this.save({
            is_listed: !0
        }, function (e) {
            return e ? n(e) : Hc(r, t, n)
        })
    }, Oc.prototype.getDataTableNames = function () {
    ...
    }, Oc.prototype.getDataTableIds = function () {
    ...
    }, Oc.prototype.dataTablesHaveChanged = function () {
        this.data_table_names = this.data_table_ids = void 0
    }, Oc.prototype.duplicate = function (e) {
        x({
            url: this.api_prefix + "/" + this.id + "/duplicate",
            callback: e
        })
    }, Oc.prototype.publish = function (t, n) {
        var r = this;
        if (this.is_listed) return Rc(r, t, n);
        this.save({
            is_listed: !0
        }, function (e) {
            return e ? t(e) : Rc(r, t, n)
        })
    }, Oc.prototype.unpublish = function (n) {
        var r = this;
        x({
    ...
    }, Oc.prototype.published = function () {
        return !!this.showcase_url
    }, Oc.prototype.sendForReview = function (e, t, n) {
        var r = this;
        x({
            url: "/api/reviews",
            payload: function () {
    ...
    }, Oc.prototype.approve = function (e, n) {
        var r = this;
        x({
    ...
    }, Oc.prototype.decline = function (e, t, n) {
        var r = this;
        x({
    ...
    }, Oc.prototype.cancelReview = function (e, n) {
        var r = this;
        x({
    ...
    }, Oc.getById = function (n, r) {
        x({
            url: "/api/visualisation/" + n,
            method: "GET",
            callback: function (e, t) {
                if (e) return r(e);
                r(void 0, new Oc(n, t.version_number, t))
            }
        })
    }, Oc.getByTemplateId = function (e, t) {
        x({
            url: "/api/template/" + e + "/visualisations",
            method: "GET",
            callback: t
        })
    }, Oc.createFromTemplate = function (e, t) {
        x({
            url: "/api/template/" + e + "/visualisations",
            method: "PUT",
            callback: t
        })
    }, Oc.createFromVisualisation = function (e, t) {
        x({
            url: "/api/visualisation/" + e + "/duplicate",
            callback: t
        })
    }, Oc.setAsStaffPick = function (e, t) {
        x({
            url: "/api/visualisation/" + e + "/set_staff_pick",
            method: "POST",
            callback: t
        })
    }, Oc.unsetAsStaffPick = function (e, t) {
        x({
            url: "/api/visualisation/" + e + "/unset_staff_pick",
            method: "POST",
            callback: t
        })
    }, Oc.setTag = function (e, t, n) {
        x({
            url: "/api/visualisation/" + e + "/folder/" + encodeURIComponent(t),
            method: "PUT",
            callback: n
        })
    }, Oc.removeTag = function (e, t, n) {
        x({
            url: "/api/visualisation/" + e + "/tag/" + encodeURIComponent(t),
            method: "DELETE",
            callback: n
        })
    }, Pc.prototype.save = function (e, t) {
        S(this, e, !0, t)
    }, Pc.prototype.delete = function (e) {
        k(this, e)
    }, Pc.prototype.move = function (e, n) {
        var r = this;
        x({
    ...
    }, Lc.prototype.save = function (e, t) {
        S(this, e, t)
    }, Lc.prototype.delete = function (e) {
        k(this, e)
    }, Lc.prototype.addSlide = function (r, i, a) {
        var o = this;
        x({
            url: "/api/slide",
            method: "PUT",
    ...
    }, Lc.prototype.moveSlide = function (e, t, n) {
        var r = e.index;
        e.move(t, function (e) {
            if (e) return n(e);
            n()
    ...
    }, Lc.prototype.duplicate = function (e) {
        x({
            url: this.api_prefix + "/" + this.id + "/duplicate",
            callback: e
        })
    }, Lc.prototype.publish = function (n, e) {
        var r = this;
        x({
    ...
    }, Lc.prototype.unpublish = function (n) {
        var r = this;
        x({
            url: this.api_prefix + "/" + this.id + "/unpublish",
            callback: function (e, t) {
    ...
    }, Lc.prototype.sendForReview = function (e, t, n) {
        var r = this;
        x({
            url: "/api/reviews",
            payload: function () {
    ...
    }, Lc.prototype.approve = function (e, n) {
        var r = this;
        x({
            url: "/api/review/" + e + "/approve",
            callback: function (e, t) {
    ...
    }, Lc.prototype.decline = function (e, t, n) {
        var r = this;
        x({
            url: "/api/review/" + e + "/decline",
            payload: function () {
    ...
    }, Lc.prototype.cancelReview = function (e, n) {
        var r = this;
        x({
            url: "/api/review/" + e + "/cancel",
            callback: function (e, t) {
    ...
    }, Lc.setAsStaffPick = function (e, t) {
        x({
            url: "/api/story/" + e + "/set_staff_pick",
            method: "POST",
            callback: t
        })
    }, Lc.unsetAsStaffPick = function (e, t) {
        x({
            url: "/api/story/" + e + "/unset_staff_pick",
            method: "POST",
            callback: t
        })
    }, Lc.setTag = function (e, t, n) {
        x({
            url: "/api/story/" + e + "/folder/" + encodeURIComponent(t),
            method: "PUT",
            callback: n
        })
    };
    var qc, Bc, Yc, zc, Vc, Xc = !(Lc.removeTag = function (e, t, n) {
        x({
            url: "/api/story/" + e + "/tag/" + encodeURIComponent(t),
            method: "DELETE",
            callback: n
        })
    });
    ...
    function Zc() {
        Qc(Bc.currentTime) >= qc.story.slides.length && (Bc.currentTime = 0), Bc.play(), me("nav .play-pause").classed("playing", !0), Xc || $c(), Xc = !0
    }

    function Gc() {
        Bc.pause(), me("nav .play-pause").classed("playing", !1)
    }

    function Qc(e) {
        for (var t = Yc.length - 1; 0 <= t; t--)
            if (e >= Yc[t].timecode) return t
    }

    function Kc() {
        var e = Qc(this.currentTime);
        qc.current_slide.index !== Yc[e].index && (e < qc.story.slides.length ? qc.loadSlide(Yc[e].index) : (Gc(), qc.story.loops_at_end && Zc()))
    }

    function eu() {
        Bc && Bc.removeEventListener("timeupdate", Kc), qc.story.is_timed ? (Bc = qc.story.audio_url ? document.getElementById("story-audio-file") : new Wc).addEventListener("timeupdate", Kc) : Bc = null
    }

    function tu() {
        var r = 0;
        (Yc = qc.story.slides.map(function (e, t) {
            var n = null == e.duration ? qc.story.default_slide_duration : e.duration;
            return {
                timecode: r += n,
                index: t + 1
            }
    ...
    function nu(e) {
        Bc && (Bc.currentTime = Yc[e].timecode)
    }
    ...
    function iu(e) {
        ru(e.target) || 32 != e.keyCode && 38 != e.keyCode && 40 != e.keyCode && 33 != e.keyCode && 34 != e.keyCode || e.preventDefault()
    }

    function au(e) {
        ru(e.target) || (39 != e.keyCode && 40 != e.keyCode && 32 != e.keyCode && 34 != e.keyCode || Vc(), 37 != e.keyCode && 38 != e.keyCode && 33 != e.keyCode || zc())
    }(Wc.prototype = {
        get currentTime() {
                ...
                3: [function (z, V, e) {
                    (function (e) {
                        var u = z(6),
                            ...
                            N = t.serializeKeysForMessage,
                            O = t.serializeException,
                            F = t.sanitize,
                            j = z(2).wrapMethod,
                        ...
                        function Y() {
                            ...
                            _getCaptureExceptionOptionsFromPlainObject: function (e, t) {
                                ...
                                return r.extra.__serialized__ = O(t), r
                            },
                            ...
                            setDataCallback: function (e) {
                                ...
                                return this._globalOptions.dataCallback = B(t, e), this
                            },
                            setBreadcrumbCallback: function (e) {
                                var t = this._globalOptions.breadcrumbCallback;
                                return this._globalOptions.breadcrumbCallback = B(t, e), this
                            },
                            setShouldSendCallback: function (e) {
                                var t = this._globalOptions.shouldSendCallback;
                                return this._globalOptions.shouldSendCallback = B(t, e), this
                            },
                            ...
                            _isRepeatData: function (e) {
                                ...
                                return !(!t || e.message !== t.message || e.transaction !== t.transaction) && (e.stacktrace || t.stacktrace ? E(e.stacktrace, t.stacktrace) : e.exception || t.exception ? C(e.exception, t.exception) : !e.fingerprint && !t.fingerprint || Boolean(e.fingerprint && t.fingerprint) && JSON.stringify(e.fingerprint) === JSON.stringify(t.fingerprint))
                            },
                        ...
                        }).setUser = Y.prototype.setUserContext, Y.prototype.setReleaseContext = Y.prototype.setRelease, V.exports = Y
    ...
    function uu() {
        if (null == ou) {
            ...
            ou = "referrer" in e ? /^https:\/\/medium.com\//.test(e.referrer) : !("auto" in e)
        }
        return ou
    }
    ...
    function su(e, t) {
        if (window.top !== window.self) {
            var n = window;
            if ("srcdoc" == n.location.pathname && (n = n.parent), cu) return e = parseInt(e, 10), void n.parent.postMessage({
                sentinel: "amp",
                type: "embed-size",
                height: e
            }, "*");
    ...
    function du(i) {
        window.addEventListener("message", function (t) {
            if (null != t.source && (t.origin === document.location.origin || t.origin.match(/\/\/localhost:\d+$|\/\/flourish-api\.com$|\.flourish\.(?:local(:\d+)?|net|rocks|studio)$|\.uri\.sh$/))) {
                var e;
                try {
                    e = JSON.parse(t.data)
                } catch (e) {
        ...
        }), lu() && (window.addEventListener("resize", hu), hu())
    }
    ...
    function pu(e, t, n, r) {
        var i;
        n && "number" == typeof n ? (i = n, n += "px") : n && n.match(/^[ \t\r\n\f]*([+-]?\d+|\d*\.\d+(?:[eE][+-]?\d+)?)(?:\\?[Pp]|\\0{0,4}[57]0(?:\r\n|[ \t\r\n\f])?)(?:\\?[Xx]|\\0{0,4}[57]8(?:\r\n|[ \t\r\n\f])?)[ \t\r\n\f]*$/) && (i = parseFloat(n)), r && "number" == typeof r && (r += "px");
        var a = document.createElement("iframe");
        return a.setAttribute("scrolling", "no"), a.setAttribute("frameborder", "0"), t.appendChild(a), n ? a.style.width = n : lu() ? a.style.width = t.offsetWidth + "px" : a.style.width = "100%", !r && (e.match(/\?/) ? e += "&auto=1" : e += "?auto=1", r = fu(i || a.offsetWidth) + "px"), r && ("%" === r.charAt(r.length - 1) && (r = parseFloat(r) / 100 * t.parentNode.offsetHeight + "px"), a.style.height = r), a.setAttribute("src", e), a
    }

    function bu() {
        return cu = "#amp=1" == window.location.hash, {
            createEmbedIframe: pu,
            isFixedHeight: uu,
            getHeightForBreakpoint: fu,
            startEventListeners: du,
            notifyParentWindow: su,
            isSafari: lu
        }
    }
    var gu = {
    ...
    var mu, yu, _u, wu, xu, Tu, Su, ku, Cu, Eu, Mu = "⬆︎",
        Au = "/api/file/upload";
    ...
    function Uu(e, t) {
        var n = e.ownerDocument.createElement("button");
        n.type = "button", n.className = "upload", n.setAttribute("title", "Upload a file from your computer"), n.innerHTML = Mu, e.insertAdjacentElement("afterend", n), t || (n.onclick = Nu)
    }

    function Nu() {
        var n = this.previousSibling,
            e = n.getAttribute("accept");
        n.disabled = !0, n.classList.toggle("uploading", !0), Ou({
            accept: e,
            success: function (e) {
                var t;
    ...
    function Ou(e) {
        var t = document.getElementById("file-uploader");
        t || ((t = document.createElement("input")).type = "file", t.setAttribute("id", "file-uploader"), t.style.display = "none", document.body.appendChild(t)), e.accept ? t.setAttribute("accept", e.accept) : t.removeAttribute("accept"), t.onchange = function () {
            gu.start(),
                function (e, r, i) {
                    var a = e[0];
                    ! function (e, n) {
                        ...
                        Fu(Au, t, function (e, t) {
                            return e ? n(e) : n(null, JSON.parse(t.responseText))
                        })
                    }(a, function (e, n) {
                        if (e) return gu.clear(), vu("Upload error", "There was a problem uploading your file: " + e), void console.error(e);
                        var t = function (e) {
                        ...
                        Fu(n.upload_url, t, function (e, t) {
                            gu.clear(), e ? (vu("Upload error", "There was a problem uploading your file (" + t.status + ")."), console.error(e), i && i()) : r(n.file_url)
                        })
                    })
    ...
    function ju() {
        _u && _u.preview_pane && _u.preview_pane.setFixedHeight && _u.preview_pane.setFixedHeight(function () {
            if (!mu) return null;
            var e = mu.nodes()[1].value;
            if ("custom" !== yu || "" == e) return null;
            var t = parseInt(e, 10);
            return isNaN(t) ? null : t
        }())
    }
    var Hu, Ru, Pu, Lu, Iu, qu = null;
    ...
    function Yu(e, t, n) {
        return Cu = !1, qu = null, (Eu = e) && e.template_id ? wu.on("load", function (e, r, i) {
            var a = e.template_id;
            return function () {
                ju(), Eu && Eu.template_id == a && (wu.on("load", null), Zu(function (e, n) {
                    e ? console.error("Failed to get default state") : Eu && Eu.template_id == a && Gu(function (e, t) {
                        e ? console.error("Failed to call hasData") : Eu && Eu.template_id == a && (t ? Eu.refreshDataBindings(function (e) {
                            e ? console.error("Failed to refresh data bindings") : Eu && Eu.template_id == a && Eu.prepareData(function (e, t) {
                                e ? console.error("Failed to prepare data for template") : Eu && Eu.template_id == a && cf({
                                    data: t,
                                    state: r,
                                    draw: !0
                                }, function (e, t) {
        ...
        }(e, t, n)).attr("src", "/template/" + e.template_id + "/embed/?auto=1&environment=" + Tu) : wu.on("load", null).attr("src", "about:blank")
    }

    function zu(e, t, n, r) {
        var i = "about:blank" === wu.attr("src");
        if (Cu = !1, t) {
            var a = e[t] || "/template/" + t + "/embed";
            a += "?environment=" + Tu, r && (a += "&auto=1"), i ? o() : wu.transition().duration(250).style("opacity", 0).on("end", o)
        } else wu.transition().duration(250).style("opacity", 0).on("end", function () {
            wu.on("load", null).attr("src", "about:blank")
        });

        function o() {
            wu.on("load", function (n) {
                return function () {
                    Zu(function (e, t) {
                        e ? console.error("Failed to get default state") : (qu = t, n())
                    })
                }
            }(function () {
                n(), i || wu.transition().duration(250).style("opacity", 1)
            })).attr("src", a)
        }
    }
    ...
    function Vu(t, n) {
        ...
        t.refreshDataBindings(function (e) {
            e ? console.error("Failed to fetch data bindings") : t.prepareData(function (e, t) {
                if (Eu && Eu.template_id == r) return e ? (console.error("Failed to prepare data for template"), void n(e)) : void n(void 0, t)
            })
        })
    }
    ...
    function Zu(e, t) {
        "function" != typeof e ? $u("getState", e, t) : $u("getState", void 0, e)
    }
    ...
    function ef(e) {
        $u("draw", void 0, e), Cu = !0
    }

    function tf(e) {
        Cu && $u("update", void 0, e)
    }
    ...
    function af(e, t) {
        $u("setFixedHeight", e, t)
    }

    function of (e) {
        if (xu.parentNode.offsetWidth) {
            if (void 0 !== e) Ru = null != e;
            else if (Ru) return;
            var t = e || ku && ku.responsive_menu && ku.responsive_menu.getHeightSetting() || Su.getHeightForBreakpoint(xu.offsetWidth);
            "number" == typeof t && (t += "px"), xu.style.height = t
        }
    }

    function cf(n, r) {
        Cu ? delete n.draw : n.draw && (Cu = !0), n.state && (n.state = Nc(n.state)), $u("sync", n, function (e, t) {
            null != e || "success" !== t ? (n.draw && (Cu = !1), function e(t) {
                t ? r && r(t) : function (e, t) {
                    return e.data ? (Qu(e.data, t), delete e.data, !1) : e.state ? (Ju(e.state, t), delete e.state, !1) : e.draw ? (ef(t), delete e.draw, !1) : !e.update || (tf(t), delete e.update, !1)
                }(n, e) && r && r(void 0)
            }(e)) : r && r(void 0)
        })
    }
    ...
    function uf(e, t, n) {
        return wu = ve(e), xu = wu.node(), Tu = t, ku = n, Hu = {
            setup: Du,
            addButton: Uu,
            startUpload: Ou
        }, Su = bu(), xu.style.height = Su.getHeightForBreakpoint(xu.offsetWidth) + "px", Su.startEventListeners(function (e) {
            "resize" == e.method ? of (e.height) : "request-upload" == e.method && function (n, e) {
                Hu.startUpload({
            ...
            loadVisualisation: Yu,
            loadTemplate: zu,
            updateData: Xu,
            updateDataAndState: Wu,
            setState: Ju,
            getState: Zu,
            getDefaultState: rf,
            hasData: Gu,
    ...
    function ff(e, t) {
        for (var n in t) "object" != typeof e[n] || null == e[n] || Array.isArray(e[n]) || "object" != typeof t[n] || null == t[n] || Array.isArray(t[n]) ? e[n] = t[n] : ff(e[n], t[n])
    }

    function sf(e, t, n, r, i) {
        var a = this;
        if (a.story = e, a.visualisations = t, a.data = n, a.template_paths = r || {}, a.auto_resize = !Lu.isFixedHeight(), a.analytics = function (e, t) {
                ...
                n = window, r = document, i = "ga", n.GoogleAnalyticsObject = i, n.ga = n.ga || function () {
                    ...
                    (n.ga.q = n.ga.q || []).push(Ic(e))
                }, n.ga.l = 1 * new Date, a = r.createElement("script"), o = r.getElementsByTagName("script")[0], a.async = 1, a.src = "https://www.google-analytics.com/analytics.js", o.parentNode.insertBefore(a, o);
                var c = {
                ...
                return ga("set", "dimension2", u.toISOString()), ga("send", "pageview", e),
                    function () {
                        4 <= arguments.length && "event" === arguments[1] && (window._mfq = window._mfq || [], window._mfq.push(["setVariable", arguments[2], arguments[3]])), window.ga.apply(window.ga, Ic(Array.prototype.slice.call(arguments)))
                    }
        ...
        function f() {
            ...
            zc = e, Vc = t
        }(u, f), window.addEventListener("keydown", iu), window.addEventListener("keyup", au), a.auto_resize ? function () {
            var t = document.querySelector("iframe"),
                n = t.offsetHeight,
                r = document.querySelector(".story-furniture");
            Lu.startEventListeners(function (e) {
                "resize" === e.method && e.height !== n && ("number" != typeof (n = e.height) && (n = parseInt(n, 10)), t.style.height = n + "px", lf(t.offsetHeight + (r ? r.offsetHeight : 0)))
            })
        }() : a.updateHeight();
        var s = !0;
        Iu = function (e) {
            ...
            s && (s = !1, Iu.jumpToSlide(a.current_slide.index)), Iu.playPause()
    ...
    function lf(e) {
        e && Lu.notifyParentWindow(e, {
            player: !0
        })
    }
    return sf.prototype.noSlidesBefore = function () {
        return !this.current_slide || this.current_slide.index < 1
    }, sf.prototype.noSlidesAfter = function () {
        return !this.current_slide || this.current_slide.index == this.story.slides.length - 1
    }, sf.prototype.previous = function () {
    ...
    }, sf.prototype.populateStateAndData = function (e, t) {
        var n = this.current_slide,
            r = n.visualisation,
            i = {};
        ff(i, Pu.getDefaultState()), ff(i, Nc(r.settingsForCurrentTemplate())), ff(i, n.state);
        var a = {
            state: i,
            overwrite_state: !0
        };
        t && (a.data = this.data[r.id]), a[e] = !0, Pu.sync(a)
    }, sf.prototype.loadSlide = function (e) {
        var n = this;
        ...
        n.current_slide = t, n.updateControls(), n.updateSlideCount(), this.analytics("send", "event", "story", "load_slide", e), t === a || (r === o ? u("update", !1)() : i === c ? u("update", !0)() : Pu.loadTemplate(n.template_paths, i, u("draw", !0), n.auto_resize))
    }, sf.prototype.updateControls = function () {
        ...
        }(e), Pu = uf("#story iframe", "story_player"), Lu = bu(), window.Flourish = window.Flourish || {};
        var a = window.Flourish.app = new sf(t, n, r, i, e);
